...
public class SaborV1RestControllerTests {
        ...
        class SaborVerificacaoPreco {
                ...
                void quandoAlteramosSaborPrecosValidos() throws Exception {
                        // Arrange
                        saborPostPutRequestDTO.setPrecoM(new BigDecimal("40.0"));
                        saborPostPutRequestDTO.setPrecoG(new BigDecimal("60.0"));
                ...
                void quandoAlteramosSaborPrecosInvalidos() throws Exception {
                        // Arrange
                        saborPostPutRequestDTO.setPrecoM(new BigDecimal("-10.0"));
                        saborPostPutRequestDTO.setPrecoG(new BigDecimal("-240.0"));
